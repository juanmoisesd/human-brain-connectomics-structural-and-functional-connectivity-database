...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18881110.svg)](https://doi.org/10.5281/zenodo.18881110)
...
[![Pages](https://img.shields.io/badge/Live-Microsite-brightgreen)](https://juanmoisesd.github.io/human-brain-connectomics-structural-and-functional-connectivity-database/)

## Overview
Repository of databases on human brain connectomics: structural connectivity (DTI, tractography) and functional connectivity (fMRI), including brain network maps and interindividual variability. Data compiled and organized for neuroscience research. Includes: name, acronym, URL, year, institution, data type, number of subjects, main features, tools, and key references.

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18881110](https://doi.org/10.5281/zenodo.18881110) |
| Platform | Zenodo |
| License | CC0 1.0 |
| Published | 2026-03-05 |

## 🌐 Interactive Microsite
**[Open Microsite](https://juanmoisesd.github.io/human-brain-connectomics-structural-and-functional-connectivity-database/)**

## Keywords


## Citation
> de la Serna Tuya, J.M. (2026). *Human Brain Connectomics: Structural and Functional Connecti*. Zenodo. https://doi.org/10.5281/zenodo.18881110
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Repository of databases on human brain connectomics: structural connectivity (DTI, tractography) and functional connectivity (fMRI), including brain network maps and interindividual variability. Data compiled and organized for neuroscience research. * [Dataset]. GitHub. https://github.com/juanmoisesd/human-brain-connectomics-structural-and-functional-connectivity-database

**BibTeX**
```bibtex
@dataset{delaserna2025_human_brain_connectomics_struc,
