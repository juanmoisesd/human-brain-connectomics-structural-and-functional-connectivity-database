...
cat("Dataset: Human Brain Connectomics: Structural and Functiona\n")
cat("DOI: 10.5281/zenodo.18881110\n")
...
p1 <- df %>%
  ...
  geom_line(size=0.8) +
  geom_point(size=1.5) +
  labs(title="Human Brain Connectomics: Structural and Functional Con",
       subtitle="DOI: 10.5281/zenodo.18881110",
       x="Year", y="Value",
...
# ── CITATION ───────────────────────────────────────────────────────────────
cat("\nCitation:\n")
cat("de la Serna Tuya, Juan Moisés (2026). Human Brain Connectomics: Structural and Functional Connectivity Datab. Zenodo. https://doi.org/10.5281/zenodo.18881110\n")
